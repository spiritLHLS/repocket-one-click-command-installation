...
After the registration link is registered, remember the email and Api Key, run this script, paste the email and Api Key, and press Enter to start the installation.
